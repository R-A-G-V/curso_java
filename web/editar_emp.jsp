      ...
      <%
       ...
       %>
        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-sm">
                    <form action="editar_em.jsp" method="post">
                        <div class="form-group">
                            <label for="nombre">Nombre</label>
                            <input type="text" name="txtnom" class="form-control"  value="<%= nombre%>" placeholder="Nombre" required="required">
                        </div>
                        <div class="form-group">
                            <label for="direccion">Direccion</label>
                            <input type="text" name="txtdirecc" value="<%=direccion%>" class="form-control" id="direccion" placeholder="Direccion" required="required">
                        </div>
                        <div class="form-group">
                            <label for="telefono">Telefono</label>
                            <input type="text" name="txttelef" value="<%=telefono%>" class="form-control" id="telefono" placeholder="Telefono" required="required">
                        </div>
                        <a href="index.jsp" class="btn btn-primary">Cancelar <i class="fas fa-ban"></i></a>
